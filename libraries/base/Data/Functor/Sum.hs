...
-- | @since 4.9.0.0
instance (Total f, Total g, Ord1 f, Ord1 g) => Ord1 (Sum f g) where
...
-- | @since 4.9.0.0
instance (Total f, Total g, Read1 f, Read1 g) => Read1 (Sum f g) where
...
-- | @since 4.9.0.0
instance (Total f, Total g, Show1 f, Show1 g) => Show1 (Sum f g) where
...
-- | @since 4.9.0.0
instance (Total f, Total g, Eq1 f, Eq1 g, Eq a) => Eq (Sum f g a) where
    (==) = eq1
-- | @since 4.9.0.0
instance (Total f, Total g, Ord1 f, Ord1 g, Ord a) => Ord (Sum f g a) where
    compare = compare1
-- | @since 4.9.0.0
instance (Total f, Total g, Read1 f, Read1 g, Read a) => Read (Sum f g a) where
    readPrec = readPrec1

    readListPrec = readListPrecDefault
    readList     = readListDefault
-- | @since 4.9.0.0
instance (Total f, Total g, Show1 f, Show1 g, Show a) => Show (Sum f g a) where
    showsPrec = showsPrec1

-- | @since 4.9.0.0
instance (Total f, Total g, Functor f, Functor g) => Functor (Sum f g) where
...
-- | @since 4.9.0.0
instance (Total f, Total g, Foldable f, Foldable g) => Foldable (Sum f g) where
    foldMap f (InL x) = foldMap f x
    foldMap f (InR y) = foldMap f y

-- | @since 4.9.0.0
instance (Total f, Total g, Traversable f, Traversable g) => Traversable (Sum f g) where
