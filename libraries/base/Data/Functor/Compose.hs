...
-- | @since 4.9.0.0
instance (f @@ g a, g @@ a, Eq1 f, Eq1 g, Eq a) => Eq (Compose f g a) where
    (==) = eq1

-- | @since 4.9.0.0
instance (f @@ g a, g @@ a, Ord1 f, Ord1 g, Ord a) => Ord (Compose f g a) where
    compare = compare1

-- | @since 4.9.0.0
instance (f @@ g a, g @@ a, Read1 f, Read1 g, Read a) => Read (Compose f g a) where
    readPrec = readPrec1
...
-- | @since 4.9.0.0
instance (f @@ g a, g @@ a, Show1 f, Show1 g, Show a) => Show (Compose f g a) where
...
-- | @since 4.9.0.0
instance (Total f, Traversable f, Traversable g) => Traversable (Compose f g) where
